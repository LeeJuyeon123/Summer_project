...
def get_args_parser(subparsers):
    ...
    # Model parameters
    subparsers.add_argument('--selection_model', default='vit_tiny_patch16_224', type=str, metavar='SELECTION_MODEL', help='Name of model to use at key converting')
    ...
    subparsers.add_argument('--seed', default=41, type=int)
    ...
    subparsers.add_argument('--budget_per_task', default=1875, type=int,)
