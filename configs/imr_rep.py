...
def get_args_parser(subparsers):
    ...
    # Model parameters
    subparsers.add_argument('--selection_model', default='vit_tiny_patch16_224', type=str, metavar='SPECULATIVE_MODEL', help='Name of model to use at key converting')
    subparsers.add_argument('--model', default='vit_large_patch16_224_adaptive_layer_drop', type=str, metavar='MODEL', help='Name of model to train')
    ...
    subparsers.add_argument('--drop', type=float, default=0.0, metavar='drop', help='Dropout rate (default: 0.)')
    subparsers.add_argument('--attn-drop', type=float, default=0.0, metavar='attn_drop', help='Attention Dropout rate (default: 0.)')
    subparsers.add_argument('--drop-path', type=float, default=0.0, metavar='drop_path', help='Drop path rate (default: 0.)')
    ...
    # * Random Erase params
    subparsers.add_argument('--reprob', type=float, default=0.25, metavar='PCT', help='Random erase prob (default: 0.25)')
    ...
    subparsers.add_argument('--distributed', default=False, type=bool, help='Use DDP')
    ...
    # Prompt parameters
    subparsers.add_argument('--use_prompt', action='store_true', help='Use prompts for training (set this flag to activate prompts)')
    ...
    # Computation Budget parameters
    subparsers.add_argument('--budget_per_task', default=1878, type=int,)
    
    # REP parameters
    subparsers.add_argument('--r', default=8, type=int,)
    subparsers.add_argument('--scheduling_factor', default=1, type=int,)    
    subparsers.add_argument('--theta', default=0.5, type=float,)
    subparsers.add_argument('--gamma', default=0.001, type=float,)
    subparsers.add_argument('--tau', default=16, type=int,)
    subparsers.add_argument('--alpha', default=0.9, type=float,)


    # Misc parameters
    subparsers.add_argument('--print_freq', type=int, default=1, help = 'The frequency of printing')