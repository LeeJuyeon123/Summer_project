...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--model', default='vit_large_patch16_224', type=str, metavar='MODEL', help='Name of model to train')
    ...
    # REP parameters
    subparsers.add_argument('--r', default=6, type=int,)
    ...
    subparsers.add_argument('--tau', default=12, type=int,)
